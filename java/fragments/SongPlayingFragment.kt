...
import utils.CurrentSongHelper
import utils.Songs
import java.util.*
...
class SongPlayingFragment : Fragment() {
    ...
    object Statified {
        ...
        var updateSongTime = object : Runnable {
            override fun run() {
                ...
                var s = TimeUnit.MILLISECONDS.toSeconds(getcurrent?.toLong() as Long) - TimeUnit.MINUTES.toSeconds(
    ...
    fun playPrevious() {
        ...
        if (
            Statified.favoriteContent?.checkifIdExists(Statified.currentSongHelper?.songId?.toInt() as Int) as Boolean) {
            Statified.fab?.setImageDrawable(ContextCompat.getDrawable(Statified.myActivity, R.drawable.favorite_on))
        } else {
            Statified.fab?.setImageDrawable(ContextCompat.getDrawable(Statified.myActivity, R.drawable.favorite_off))
        }
    ...
    fun bindShakeListener() {
        Statified.mSensorListener = @RequiresApi(Build.VERSION_CODES.CUPCAKE)
